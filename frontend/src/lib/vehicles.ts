...
export const VEHICLE_STAFF_ROLES = ['super_admin', 'admin', 'hr_manager', 'hr_specialist', 'cfo', 'accounting_manager', 'accountant'];
export const VEHICLE_ADMIN_ROLES = ['super_admin', 'admin', 'hr_manager', 'cfo', 'accounting_manager'];
