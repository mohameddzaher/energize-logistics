...
const operationsPage = {
  en: {
    ...
    thPaymentAmount: 'مبلغ السداد', thPaymentType: 'نوع الدفع',
    thCollectedAmount: 'مبلغ التحصيل',
    thDocNumber: 'رقم السند', thSendingDate: 'تاريخ الارسال',
    thBranchDeliveryDate: 'تاريخ التسليم للفرع',
    thDeliveryDate: 'تاريخ التسليم للعميل', thAccountingReview: 'مراجعه الحسابات',
