// app/display-small-room/page.tsx
"use client";
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Loading Small Room Schedule...</p>
        </div>
      </div>
    );
  }
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xs">
                  EnergiZe Logistics - Small Meeting Room (up to 10 people)
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-gray-300">Booked - Small Room</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2 text-xs text-gray-400">
              ...
              <span>Small Room Display - Auto updates every 30 seconds</span>
            </div>
          </div>
        </div>
      </div>
