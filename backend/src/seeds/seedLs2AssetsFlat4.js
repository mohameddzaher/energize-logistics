/**
 * Seed the ls2 fleet-asset registry from data/masters/truck_tires_flat4.json —
 * the workshop's fourth collection round (4 more trucks), flat rows like round
 * two but with English section keys (head/trailer/spare) and a bare hasSensor
 ...
 *
 * Run: node src/seeds/seedLs2AssetsFlat4.js
 */
require('dotenv').config({ path: require('path').join(__dirname, '../../.env') });
const mongoose = require('mongoose');
const rows = require('../data/masters/truck_tires_flat4.json');
