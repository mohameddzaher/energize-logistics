...
//           className="text-sm md:text-sm font-bold mb-8 mt-8 text-left max-w-xl"
//         >
//           Reliable logistics, smarter supply chains and seamless international
//           shipping solutions. <br />We help you move goods faster and safer.
//         </motion.p>
  ...
  return (
    <section className="relative w-full h-screen">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0">
          <div className="absolute left-0 top-0 bottom-0 w-full bg-gradient-to-r from-black/80 via-black/80 to-black/80" />
          {/* <div className="absolute right-0 top-0 bottom-0 w-1/2 bg-gradient-to-l from-black/80 to-transparent" /> */}
        </div>
      </div>
      ...
      <div className="relative z-10 flex flex-col justify-start pt-32 items-left h-full px-6 md:px-24 text-white">
        ...
        <motion.p
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 1.2, delay: 0.5 }}
          className="text-xs text-gray-300 mt-6 text-left max-w-md"
        >
          Need to schedule a meeting? Book our conference room instantly with our online booking system
        </motion.p>
      </div>

      {/* Small element on right side */}
      <motion.div
        initial={{ opacity: 0, x: 30 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.8, delay: 0.6 }}
        className="absolute right-12 bottom-32 md:right-24 md:bottom-80"
      >
