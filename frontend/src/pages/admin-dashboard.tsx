...
//     // ✅ إصلاح: تحويل الوقت بشكل صحيح لـ datetime-local
...
//     try {
//       // ✅ إصلاح: تحويل البيانات بشكل صحيح قبل الإرسال
//       const updateData = {
//         ...editFormData,
...
//       if (result.status === 'success') {
//         // ✅ إصلاح: تحديث القائمة بالبيانات الجديدة
...
//             <h3 className="text-lg font-semibold text-gray-300 mb-2">Active Today</h3>
//             <p className="text-3xl font-bold text-orange-400">
//               {bookings.filter(b => new Date(b.startTime).toDateString() === new Date().toDateString()).length}
//             </p>
//           </div>
//         </div>
