    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
        ...
        <p className="text-slate-500 text-sm mb-4">
          {lang === 'ar' ? 'أنشئ توقيعك (بالرسم أو برفع صورة) لاستخدامه في الموافقات والمستندات، مثل طلبات الإجازة.' : 'Create your signature (draw or upload) to apply it on approvals and documents like leave requests.'}
        </p>
        <SignatureManager />
      </div>
