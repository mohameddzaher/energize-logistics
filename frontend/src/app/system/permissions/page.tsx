 ...
 *
 * فصار للسؤال وجهان:
 *   • **القسم** → ممنوع / مشاهدة / تعديل. وهو حارسُ البيانات على الخادم.
 *   • **الصفحة** → مفتوحةٌ أو مغلقة، داخلَ ما منحه القسم. وهي أيُّ الشاشات تُفتَح.
 *
              ...
              <div className="flex items-center justify-between gap-3">
                <p className="text-[11.5px] text-slate-400 flex items-center gap-1.5 min-w-0">
                  ...
                  <span className="truncate">
                    {t('صلاحيّةُ الصفحة تحرس الشاشات؛ وحارسُ البيانات على الخادم هو القسم.',
                       'Page access guards screens; the section is what guards the data on the server.')}
                  </span>
                </p>
