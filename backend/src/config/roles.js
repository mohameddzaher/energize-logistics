...
const SECTION_ROLES = [
  ...
  { section: 'B2C',
    ...
    // ── والمشرفُ ليس دورًا ثالثًا ────────────────────────────────────────
    // «مشرفُ المندوبين» صلةٌ لا صلاحيّة: مَن يُذكَر في `B2CRep.supervisor` يرى
    // مندوبيه في شاشة التفقّد، ومَن لا مندوبَ له لا يرى شيئًا — والدورُ نفسُه
    // (مدير مشروع أو مدير القطاع) هو ما يفتح الشاشة. ولو صُنع له دورٌ ثالثٌ
    // هنا لَكُسرت قاعدةُ هذا الملفّ (مديرٌ وموظّفٌ لكلّ قسم) بلا أن يُكسَب شيء:
    // الصلاحيّةُ واحدةٌ والفرقُ في البيانات.
