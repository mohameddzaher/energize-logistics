...
export const FINANCE_STAFF_ROLES = ['super_admin', 'admin', 'cfo', 'accounting_manager', 'accountant'];
export const FINANCE_ADMIN_ROLES = ['super_admin', 'admin', 'cfo', 'accounting_manager'];
