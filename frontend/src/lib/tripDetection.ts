...
export const KNOWN_CITIES: { key: string; variants: string[] }[] = [
  // Major cities
  { key: 'Jeddah', variants: ['جدة', 'جده', 'Jeddah', 'Jedda', 'Jiddah'] },
  { key: 'Riyadh', variants: ['الرياض', 'Riyadh', 'Ar Riyad', 'Al Riyadh'] },
  { key: 'Dammam', variants: ['الدمام', 'Dammam', 'Ad Dammam'] },
  { key: 'Mecca', variants: ['مكة', 'مكه', 'Mecca', 'Makkah', 'Makka', 'Al Makkah'] },
  { key: 'Medina', variants: ['المدينة المنورة', 'المدينة', 'المدينه', 'Medina', 'Madinah', 'Al Madinah', 'Al Madina'] },
  // From user's list
  { key: 'Yanbu', variants: ['ينبع', 'Yanbu'] },
  { key: 'Sudair', variants: ['سدير', 'Sudair', 'Sedair'] },
  { key: 'Rabigh', variants: ['رابغ', 'Rabigh'] },
  { key: 'Jazan', variants: ['جيزان', 'جازان', 'Jizan', 'Jazan'] },
  { key: 'Buraidah', variants: ['بريدة', 'بريده', 'Buraidah', 'Buraydah'] },
  { key: 'Al Khafji', variants: ['الخفجي', 'Al Khafji', 'Khafji'] },
  { key: 'Qassim', variants: ['القصيم', 'Qassim', 'Al Qassim'] },
  { key: 'Hail', variants: ['حائل', 'Hail'] },
  { key: 'Wadi Al Dawaser', variants: ['وادي الدواسر', 'Wadi Al Dawaser', 'Wadi ad Dawasir'] },
  { key: 'Shaqra', variants: ['شقراء', 'Shaqra', 'Shaqraa'] },
  { key: 'Taif', variants: ['الطائف', 'Taif', 'Al Taif', 'At Taif'] },
  { key: 'S3', variants: ['ص٣', 'ص3', 'S3'] },
  { key: 'Khamis Mushait', variants: ['خميس مشيط', 'Khamis Mushait', 'Khamis'] },
  { key: 'Al Kharj', variants: ['الخرج', 'Al Kharj', 'Kharj'] },
  { key: 'Bisha', variants: ['بيشة', 'بيشه', 'Bisha'] },
  { key: 'Hafr Al Batin', variants: ['حفر الباطن', 'Hafr Al Batin', 'Hafar Al Batin'] },
  { key: 'Tanajib', variants: ['تناجيب', 'Tanajib'] },
  { key: 'Jubail', variants: ['الجبيل', 'Jubail', 'Al Jubail'] },
  { key: 'Al Dawadmi', variants: ['الدوادمي', 'Al Dawadmi', 'Dawadmi'] },
  { key: 'Khulais', variants: ['خليص', 'Khulais'] },
  { key: 'Al Ahsa', variants: ['الاحساء', 'الأحساء', 'الحسا', 'Al Hasa', 'Ahsa', 'Al Ahsa', 'Al-Hasa', 'Al Ahsaa'] },
  { key: 'Khobar', variants: ['الخبر', 'Khobar', 'Al Khobar'] },
  { key: 'Baz', variants: ['باز', 'Baz'] },
  { key: 'Ras Al Khair', variants: ['راس الخير', 'رأس الخير', 'Ras Al Khair', 'Ras Alkhair'] },
  { key: 'Al Laith', variants: ['الليث', 'Al Laith', 'Laith'] },
  { key: 'Abha', variants: ['ابها', 'أبها', 'Abha'] },
  { key: 'Fuladh Al Muttahida', variants: ['فلذ المتحدة', 'فولاذ المتحدة', 'Fuladh Al Muttahida'] },
  { key: 'Al Muzahmiyya', variants: ['المزاحمية', 'Al Muzahmiyya', 'Muzahmiya'] },
  { key: 'Hurimilaa', variants: ['حرميلاء', 'حريملاء', 'Hurimilaa', 'Huraymala', 'Huraimla'] },
  { key: 'Qatif', variants: ['القطيف', 'Qatif', 'Al Qatif'] },
  { key: 'Dhurma', variants: ['ضرما', 'Dhurma', 'Dharma'] },
  { key: 'Sabya', variants: ['صبيا', 'Sabya', 'Sabiya'] },
  { key: 'Hofuf', variants: ['الهفوف', 'Hofuf', 'Al Hofuf'] },
  { key: 'Hadarah', variants: ['الهدارة', 'Hadarah', 'Al Hadarah'] },
  { key: 'Hawtat Sudair', variants: ['حوطه سدير', 'حوطة سدير', 'Hawtat Sudair', 'Hautat Sudair'] },
  { key: 'Usfan', variants: ['عسفان', 'Usfan', 'Osfan'] },
  { key: 'Al Hanakiyah', variants: ['الحناكيه', 'الحناكية', 'Al Hanakiyah', 'Hanakiyah'] },
  { key: 'Turaif', variants: ['طريف', 'Turaif', 'Turayf'] },
  { key: 'Al Ula', variants: ['العلا', 'Al Ula', 'AlUla'] },
  { key: 'Al Wajh', variants: ['الوجه', 'Al Wajh', 'Wajh'] },
  { key: 'Al Rass', variants: ['الرس', 'Al Rass', 'Rass'] },
  { key: 'Tabuk', variants: ['تبوك', 'Tabuk'] },
  { key: 'Turayb', variants: ['طريب', 'Turayb', 'Turaib'] },
  { key: 'Al Batha', variants: ['البطحاء', 'Al Batha', 'Batha'] },
  { key: 'Al Saariyah', variants: ['السعريه', 'السعرية', 'Al Saariyah', 'Saariyah'] },
  { key: 'Rudwan', variants: ['رضوان', 'Rudwan', 'Radwan'] },
  { key: 'Afif', variants: ['عفيف', 'Afif', 'Afeef'] },
  { key: 'Najran', variants: ['نجران', 'Najran'] },
  { key: 'Al Khumrah', variants: ['الخمره', 'الخمرة', 'Al Khumrah', 'Khumrah'] },
  { key: 'Muhayil Asir', variants: ['محايل عسير', 'Muhayil Asir', 'Muhayil'] },
  { key: 'Nairiyah', variants: ['النعيريه', 'النعيرية', 'Nairiyah', 'Nairyah'] },
  { key: 'Al Shaabiyah', variants: ['الشعبية', 'الشعبيه', 'Al Shaabiyah', 'Shaabiya'] },
  { key: 'Ras Tanura', variants: ['راس تنوره', 'رأس تنورة', 'Ras Tanura', 'Ras Tanurah'] },
  { key: 'Al Bujadiyah', variants: ['البجاديه', 'البجادية', 'Al Bujadiyah', 'Bujadiyah'] },
  { key: 'Amaala', variants: ['امالا', 'AMAALA', 'Amaala', 'Amala'] },
];
