        ...
        <table className="w-full">
          <thead>
            <tr className="bg-gray-800 border-b border-gray-700">
              ...
              <th className="px-4 py-3 text-left text-xs text-gray-400 uppercase">{T.totalPaid}</th>
              <th className="px-4 py-3 text-left text-xs text-gray-400 uppercase">{T.balance}</th>
              <th className="px-4 py-3 text-left text-xs text-gray-400 uppercase">{T.invoiceDate}</th>
              <th className="px-4 py-3 text-left text-xs text-gray-400 uppercase">{T.dueDate}</th>
              <th className="px-4 py-3 text-left text-xs text-gray-400 uppercase">{T.date}</th>
              <th className="px-4 py-3 text-left text-xs text-gray-400 uppercase">{T.status}</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-700/50">
            {data?.invoices?.map((inv: any) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-sm text-green-400">{inv.paidAmount?.toLocaleString()}</td>
                <td className="px-4 py-3 text-sm text-gray-300 font-medium">{inv.balance?.toLocaleString()}</td>
                <td className="px-4 py-3 text-sm text-gray-400">{new Date(inv.invoiceDate).toLocaleDateString()}</td>
