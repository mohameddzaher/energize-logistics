...
const layout = {
  en: {
    ...
    sectionCRM: 'CRM',
    sectionSales: 'Sales',
    sectionAccounting: 'Finance Management',
    ...
    roleFinanceManager: 'Chief Financial Officer',
    roleAccountingManager: 'Accounting Manager',
  ...
  ar: {
    ...
    sectionAccounting: 'الإدارة المالية',
    ...
    roleAccountingManager: 'مدير الحسابات',
...
export const ROLE_LABEL_KEYS: Record<string, keyof typeof layout.en> = {
  ...
  cfo: 'roleFinanceManager',
  accounting_manager: 'roleAccountingManager',
